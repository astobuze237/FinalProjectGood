...
{
    public partial class BlueGame : UserControl
    {
        ...
        SolidBrush characterBrush = new SolidBrush(Color.Green);
        ...
        private void BlueGame_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Left:
        ...
        private void BlueGame_KeyUp(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Left:
        ...
        private void BlueGame_Paint(object sender, PaintEventArgs e)
        {
